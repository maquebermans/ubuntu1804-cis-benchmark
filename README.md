Ansible roles and playbook for ubuntu 18.04 security hardening based on CIS benchmark 
================
...
Executing Roles Through Playbook
------------
```
ansible-playbook playbook/cis_benchmark_1804.yml -i inventories/hosts1.ini -l hostname1, hostname2, hostname3 -u root
ansible-playbook playbook/cis_benchmark_1804.yml -i inventories/hosts2.ini -l hostname1 -u root
ansible-playbook playbook/cis_benchmark_1804.yml -i inventories/hosts3.ini -u root
```